...
/* =====================================================
   ชั่วคราว — ตรวจสอบว่า Incidents ถูกบันทึก type/cause ถูกต้องจริง
   ก่อนจะไปแก้ Firestore rules ให้แอปอ่านได้ (ลบทิ้งได้หลังเช็คเสร็จ)
===================================================== */
app.get("/debug/incidents/:nanoId", async (req, res) => {
  ...
  try {
    ...
    console.error("❌ debug/incidents error:", err);
    res.status(500).send("Error");
  }
});